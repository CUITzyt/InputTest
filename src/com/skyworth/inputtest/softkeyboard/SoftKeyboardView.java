...
import com.skyworth.inputtest.softkeyboard.SoftKey.SaveSoftKey;
import com.skyworth.inputtest.softkeyboard.OPENLOG;
...
public class SoftKeyboardView extends View {
    ...
    private void drawSoftKeySelectState(Canvas canvas, SoftKey softKey) {
        ...
        if (selectDrawable != null) {
            ...
            rect = new Rect(rect.left - leftPadding, rect.top - rightPadding, rect.right + topPadding,
    ...
    private void setMoveSoftKeyAnimation(SoftKey oldSoftkey, SoftKey targetSoftKey) {
        PropertyValuesHolder valuesXHolder = PropertyValuesHolder.ofFloat("Left", oldSoftkey.getLeft(),
                targetSoftKey.getLeft());
        PropertyValuesHolder valuesX1Holder = PropertyValuesHolder.ofFloat("Right", oldSoftkey.getRight(),
                targetSoftKey.getRight());
        PropertyValuesHolder valuesYHolder = PropertyValuesHolder.ofFloat("Top", oldSoftkey.getTop(),
                targetSoftKey.getTop());
        PropertyValuesHolder valuesY1Holder = PropertyValuesHolder.ofFloat("Bottom", oldSoftkey.getBottom(),
                targetSoftKey.getBottom());
        //
        final ObjectAnimator scaleAnimator = ObjectAnimator.ofPropertyValuesHolder(targetSoftKey, valuesXHolder,
                valuesX1Holder, valuesYHolder, valuesY1Holder);
