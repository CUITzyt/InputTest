...
public class SkbContainer extends RelativeLayout implements SoftKeyBoardable {
    ...
    private void onUpCase(SoftKey key) {
        if (mSoftKeyListener != null) {
            mSoftKeyListener.onUpperCase(key);
        }
    }
    ...
    public boolean onSoftKeyDown(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_DEL:
            ...
            break;
        case SaveKeyEvent.SOFTKEY_UPPERCASE:
            tempSoftKey.setKeyCode(SaveKeyEvent.SOFTKEY_UPPERCASE);
            onUpCase(tempSoftKey);
            break;
