...
import com.skyworth.inputtest.softkeyboard.SkbContainer;
import com.skyworth.inputtest.softkeyboard.SoftKey;
import com.skyworth.inputtest.softkeyboard.SoftKeyBoardListener;
 ...
 * 暂时的demo. top_bottom_move 是设置上下不循环. left_right_move 默认为true,就像DEMO里一样，是左右循环的.
 * 具体看DEMO. 千万不要将 keyCode设置为 0.
 */
public class DemoKeyBoardActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        skbContainer.setSkbLayout(R.xml.sbd_qwerty_low);
        ...
        skbContainer.setOnSoftKeyBoardListener(new SoftKeyBoardListener() {
            ...
            public void onUpperCase(SoftKey key) {
                ...
                Log.i("Sdt_Zyt"," KeyBoardActivity onUpperCase ");
            }
    ...
    private void setSkbContainerMove() {
        ...
        RectF rectf = new RectF((int) getResources().getDimension(R.dimen.w_25),
                (int) getResources().getDimension(R.dimen.h_25), (int) getResources().getDimension(R.dimen.w_25),
                (int) getResources().getDimension(R.dimen.h_25));
    ...
    /**
     * 切换布局测试. 因为布局不相同，所以属性不一样， 需要重新设置(不用参考我的,只是DEMO)
     */
